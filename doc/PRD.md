...
钓到各星级鱼的概率是按照以下方式计算的：
  ...
  1. 钓鱼成功后，系统会根据鱼类的稀有度(rarity)来分配权重
  2. 稀有度越高，权重越低，意味着越难钓到
  3. 具体权重计算公式为：weights = [1.0 / (fish.rarity ** 2) for fish in fish_templates]
  4. 然后使用random.choices()根据权重随机选择鱼类
  ...
  从initial_data.py中可以看到各星级鱼类的数量分布：
  - 1星鱼：25种
  - 2星鱼：25种
  - 3星鱼：26种
  - 4星鱼：22种
  ...
  总权重 = 25.0 + 6.25 + 2.86 + 1.375 + 0.72 = 36.205

  各星级鱼的实际概率：
  - 1星鱼：25.0 / 36.205 ≈ 69.05%
  - 2星鱼：6.25 / 36.205 ≈ 17.26%
  - 3星鱼：2.86 / 36.205 ≈ 7.90%
  - 4星鱼：1.375 / 36.205 ≈ 3.80%
  - 5星鱼：0.72 / 36.205 ≈ 1.99%
